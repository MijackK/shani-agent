...
export const en: Translations = {
  ...
  updates: {
    ...
    blockerBody: 'Shani needs to stop these local previews before updating. This will not modify or delete your files.',
  ...
  install: {
    ...
    setupChoiceDesc: 'Connect this app to a Shani gateway you already run, or install Shani locally on this computer.',
