...
export const zh = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      toursTitle: '引导导览',
      toursDesc: '让 Shani 逐步高亮每个位置，带你熟悉应用。开始使用满30天后自动关闭，你可以重新开启。',
    ...
    mcp: {
      ...
      deepLinkDescription: '一个链接请求将此 MCP 服务器添加到 Shani。请检查下方的完整配置——它来自该链接，而非 Shani。',
  ...
  updates: {
    ...
    applyingBody: 'Shani 更新器会在自己的窗口中接管，并在完成后自动重新打开 Shani。更新期间请不要自行重新打开 Shani。',
